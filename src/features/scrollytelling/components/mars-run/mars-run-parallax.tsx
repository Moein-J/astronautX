...
export function MarsRunParallax() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative flex min-h-dvh w-full flex-col items-center justify-between overflow-hidden bg-linear-to-b from-transparent via-red-950/20 to-transparent px-4 py-6 sm:py-8 md:py-12"
    >
      {/* Top Header Badge Spacer */}
      <div className="h-1 sm:h-3 md:h-4" />

      {/* Section Header */}
      <div className="relative z-20 my-auto flex w-full max-w-4xl flex-col items-center space-y-2.5 text-center sm:space-y-4">
        ...
        <h2 className="bg-linear-to-r from-white via-orange-100 to-red-400 bg-clip-text text-2xl font-extrabold tracking-tight text-transparent sm:text-4xl md:text-5xl lg:text-6xl">
          Running Around Mars
        </h2>
      ...
      <div className="relative z-10 my-3 sm:my-6 flex w-full max-w-4xl items-center justify-center">
        <MarsRunnerRig
      ...
      {/* Footer Indicator — Hidden on short height viewports (<680px) to prevent vertical overflow */}
      <div className="hidden min-h-[680px]:flex relative z-20 mb-1 items-center gap-2 font-mono text-[10px] tracking-widest text-slate-400 uppercase sm:text-xs">
