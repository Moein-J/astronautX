...
export function ScrollProgressBar({ className = "" }: TScrollProgressBarProps) {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 z-50 ${className}`}>
      ...
      <div className="absolute top-4 left-6 hidden sm:flex items-center gap-3 px-3 py-1.5 rounded-full bg-slate-950/70 border border-white/10 backdrop-blur-md text-[11px] font-mono text-cyan-400/90 tracking-wider">
